...
void ::WTF_UWP10_Demo::DirectXPage::InitializeComponent()
{
    if (_contentLoaded)
    {
        return;
...
void ::WTF_UWP10_Demo::DirectXPage::Connect(int __connectionId, ::Platform::Object^ __target)
{
        ...
        case 3:
            {
                ...
                (safe_cast<::Windows::UI::Xaml::Controls::AppBarButton^>(element3))->Click += ref new ::Windows::UI::Xaml::RoutedEventHandler(this, (void (::WTF_UWP10_Demo::DirectXPage::*)
...
::Windows::UI::Xaml::Markup::IComponentConnector^ ::WTF_UWP10_Demo::DirectXPage::GetBindingConnector(int __connectionId, ::Platform::Object^ __target)
{
